...
type Location = {
    provinsi: Prisma.provinsiGetPayload<{}>[];
    kabukota: Prisma.kabukotaGetPayload<{}>[];
    kecamatan: Prisma.kecamatanGetPayload<{}>[];
    kelurahan: Prisma.kelurahanGetPayload<{}>[];
};
...
export default function CustProfile() {
    ...
    return (
        <div className="col-span-3 h-full rounded-xl bg-white p-6">
