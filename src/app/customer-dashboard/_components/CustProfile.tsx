          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="space-y-2 flex-1">
              <Input 
                ...
                value={isEditing ? editData.nama_panjang || '' : userData?.nama_panjang || ''}
                onChange={e => setEditData({ ...editData, nama_panjang: e.target.value })}
        ...
        <Card className="p-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <LocationSelector
              ...
              onChange={(id) => setSelectedLocations(prev => ({
                ...prev,
                provinsiId: id,
                kabukotaId: '',
                kecamatanId: '',
